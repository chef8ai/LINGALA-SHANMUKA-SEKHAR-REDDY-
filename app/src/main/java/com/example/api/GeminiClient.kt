...
// --- Gemini REST Payloads (Moshi Compatible) ---
...
data class SchemaProperty(
    @Json(name = "type") val type: String, // "STRING" or "ARRAY"
...
object GeminiRetrofitClient {
    ...
    // 60-second timeouts as mandated by the gemini-api skill guide to prevent network cutoff
...
// --- Response Parser Helper for App UI ---
@JsonClass(generateAdapter = true)
data class FridgeChefAIResponse(
    @Json(name = "recipeName") val recipeName: String,
    @Json(name = "cookTime") val cookTime: String,
    @Json(name = "wasteSavedText") val wasteSavedText: String,
